...
class MACNN(nn.Module):
    def __init__(self, attention_heads=8, attention_hidden=256, MoE=False):
...
class MACNN4times(nn.Module):
    def __init__(self, attention_heads=8, attention_hidden=256):
        super(MACNN4times, self).__init__()
        self.attention_heads = attention_heads
        self.attention_hidden = attention_hidden
...
class MACNNOneVSAll(nn.Module):
    def __init__(self, attention_heads=8, attention_hidden=256):
        super(MACNNOneVSAll, self).__init__()
        self.mod_neutral = MACNN(attention_heads=attention_heads,
                                 attention_hidden=attention_hidden, MoE=True)
